  ...
  const telemetry = deepMerge(
    {
      ...
      webgpu: {
        ...
        queueRelief: {
          ...
          phase: "disabled",
          generation: 0,
          uploadCallThreshold: 8192,
          uploadByteThreshold: 16777216,
          intervalCalls: 0,
          intervalBytes: 0,
          passDepth: 0,
          triggerCount: 0,
...
export function flattenCausalTelemetry(value) {
  ...
  const queueRelief = telemetry.webgpu.queueRelief;
  const flattened = {
    ...
    causalWgpuQueueReliefRequested: queueRelief.requested,
    causalWgpuQueueReliefEnabled: queueRelief.enabled,
    causalWgpuQueueReliefPhase: queueRelief.phase,
    causalWgpuQueueReliefTriggerCount: queueRelief.triggerCount,
    causalWgpuQueueReliefCallThreshold: queueRelief.uploadCallThreshold,
    causalWgpuQueueReliefByteThreshold: queueRelief.uploadByteThreshold,
    causalWgpuQueueReliefMaxIntervalCalls: queueRelief.maxIntervalCalls,
    causalWgpuQueueReliefMaxIntervalBytes: queueRelief.maxIntervalBytes,
    causalWgpuQueueReliefCallOvershootMax: queueRelief.callOvershootMax,
    causalWgpuQueueReliefByteOvershootMax: queueRelief.byteOvershootMax,
    causalWgpuQueueReliefRequestedCount: queueRelief.completionRequestedCount,
    causalWgpuQueueReliefCompletedCount: queueRelief.completionCompletedCount,
    causalWgpuQueueReliefFailedCount: queueRelief.completionFailedCount,
    causalWgpuQueueReliefStaleCount: queueRelief.completionStaleCount,
    causalWgpuQueueReliefWaitAverageMs: queueRelief.waitAverageMs,
    causalWgpuQueueReliefWaitP95Ms: queueRelief.waitP95Ms,
    causalWgpuQueueReliefWaitMaxMs: queueRelief.waitMaxMs,
    causalWgpuQueueReliefArmBacklogMax: queueRelief.armBacklogMax,
    causalWgpuQueueReliefResumeBacklogLast: queueRelief.resumeBacklogLast,
    causalWgpuQueueReliefSuppressedPresentationDrains:
      queueRelief.suppressedPresentationDrainCount,
    causalWgpuQueueReliefSuppressedPumpDrains: queueRelief.suppressedPumpDrainCount,
