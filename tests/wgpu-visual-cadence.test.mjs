...
test("wgpuvisual is explicit and defaults off", () => {
...
test("host and worker plumb an opt-in hardware-only presenter readback", async () => {
  ...
  assert.match(host, /requestedWgpuVisualCadence\(window\.location\.search\)/);
